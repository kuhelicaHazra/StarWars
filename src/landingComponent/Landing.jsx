  ...
  return (
    ...
    >
      <InfiniteScroll
        ...
        endMessage={<Divider className='divider' plain>That is all, nothing more 🤐</Divider>}
        ...
        <List
          ...
          renderItem={(item) => (
            <List.Item key={item.name}>
              <List.Item.Meta
                avatar={<><Avatar src={item.avatar} /> <Avatar size={100} className='App-logo' src={item.spaceshipImage} /></>}
                title={
              ...
              <MovieSvg/>
                ...
                <div className='content'>
                  <QqOutlined style={{color: 'red', fontSize: '20px'}}/>
